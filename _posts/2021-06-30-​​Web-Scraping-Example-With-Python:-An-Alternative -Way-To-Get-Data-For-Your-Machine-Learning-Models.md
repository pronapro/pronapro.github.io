...
## Assumption 
I assume you have basic knowledge about HTML and HTML tags. If you are not familiar with HTML tags check out w3school for a basic introduction.

# Data To Extract 
The first thing to do with web scraping is finding the website you want to get data from. In this post, we are going to extract List of national independence days data from Wikipedia. now that we know the website we are getting data from below are the steps we are going to follow :
...
Please check out my youtube channel and subscribe I will be posting more videos there.
